sap.ui.define([
    ...
    return Controller.extend("tips.mes.controller.contents.producionMgmt.submenu.Regisger", {
        onInit : function () {
        	this.localApi();
        },
        ...
        {
            var oParam = {
                url     : "/productionMgmt/register/productionList",
                data	: "",
...
//            console.log(oTable.getModel("oModel2"))
        ...
        onOpenRegisterDialog : function () {
            this.getOwnerComponent().openRegisterDialog();
        }
    });
});